...
\begin{itemize}
 ...
 \begin{itemize}
  \item Nota: la distanza tra due orbite a differenti livelli energetici tende a $0$ per $x\to\infty$
 \end{itemize}
 ...
 \begin{itemize}
   \item Intorno ai punti di massimo ci sarà un'orbita in cui il grafico incontra l'asse $x$ (supponiamo, ad esempio, nel punto $(x_0, 0)$), arrivando a tangere le rette di equazione $$y = \pm\sqrt{U''(x_0)}(x-x_0)$$
 \end{itemize}
