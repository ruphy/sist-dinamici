...
Per il teorema di esistenza e unicità non possono esservi allora orbite che non la intersechino.
...
Questa proposizione serve perché basta tracciare le curve di livello identificandone eventuali singolarità. Ogni curva di livello è un insieme di orbite.
...
Un sistema è conservativo se $F(x)$ ammette primitiva $U(x)$ tale che $F(x) = -\dfrac{\partial U}{\partial x}$
...
$$\dfrac{d}{dt}\dfrac{\partial L}{\partial\dot{q}_i} = \dfrac{\partial L}{\partial q_i}$$
\subsection{Come risolvere un esercizio}
